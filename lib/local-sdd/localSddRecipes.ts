...
export const TASK_TYPE_COPY: Record<SddInput["taskType"], string> = {
...
export const RECIPE_KEYWORDS: Record<LocalRecipeId, string[]> = {
  auth: [
    "auth",
    "autenticacao",
    "login",
...
export const LOCAL_RECIPE_IDS: ReadonlyArray<LocalRecipeId> = [
  "auth",
  "ecommerce",
  "dashboard",
  "api",
...
export const LOCAL_RECIPES: Record<LocalRecipeId, LocalRecipe> = {
  auth: {
    id: "auth",
